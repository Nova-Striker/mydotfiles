# Generated by Powerlevel10k configuration wizard on 2020-10-26 at 13:38 IST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 49789.
# Wizard options: compatible, classic, ascii, darkest, 12h time, 1 line, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # os_icon               # os identifier dir                     # current directory
    vcs                     # git status
